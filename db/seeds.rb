...
course1 = Course.create(name: "C++ Programming", course_id: "CS-1210", credits: 3, description: "Never", course_type: "GenEd")
course2 = Course.create(name: "Object Oriented Design", course_id: "CS-1220", credits: 3, description: "Gonna", course_type: "Major")
course3 = Course.create(name: "Java Programming", course_id: "CS-2210", credits: 3, description: "Give", course_type: "Major")
course11 = Course.create(name: "History of Potato", course_id: "PO-1210", credits: 3, description: "The Cobbler's Bench, the Monkey Chased the Weasel", course_type: "GenEd")
course21 = Course.create(name: "Calc I", course_id: "MATH-17100", credits: 5, description: "Around", course_type: "GenEd")
course31 = Course.create(name: "Algorithms", course_id: "CS-3410", credits: 3, description: "Up", course_type: "Major")
course12 = Course.create(name: "Compiler", course_id: "CS-3510", credits: 3, description: "Never", course_type: "Track")
course22 = Course.create(name: "Computer Architecture", course_id: "ENCP-3210", credits: 3, description: "Run", course_type: "Track")
course32 = Course.create(name: "Computer Graphics", course_id: "CS-4710", credits: 3, description: "You", course_type: "Track")
course14 = Course.create(name: "Databases", course_id: "CS-3610", credits: 3, description: "Gonna", course_type: "Major")
course24 = Course.create(name: "DLD", course_id: "ENCP-1010", credits: 3, description: "Gonna", course_type: "GenEd")
course34 = Course.create(name: "O/S", course_id: "CS-3220", credits: 3, description: "You", course_type: "Major")
course15 = Course.create(name: "Parallel Computing", course_id: "CS-4410", credits: 3, description: "Let", course_type: "GenEd")
course25 = Course.create(name: "Software Engineering I", course_id: "CS-4810", credits: 3, description: "Down", course_type: "Major")
course35 = Course.create(name: "Software Engineering II", course_id: "CS-4820", credits: 3, description: "Never", course_type: "Major")
